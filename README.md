...
| ------------------- | --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Revenue Manager** | **1. Build Customer Loyalty**     | • Over **99% of cancellations** came from **new guests**, making the “book–cancel” behavior unpredictable.                                                                                                                                                                                                                                                   | • Strengthen customer loyalty programs to increase repeat guests.<br>• Encourage a clearer distinction between “guaranteed guests” and “non-guaranteed guests.”                                                                                                                                                                               |
| **Revenue Manager** | **2. Review Cancellation Policy** | • Despite offering a **No Deposit policy**, many guests still canceled **on the check-in day**.                                                                                                                                                                                                                                                              | • Reassess and tighten the cancellation policy for each hotel type.<br>• Proactively communicate cancellation rules during the booking process (especially through TA/TO).<br>• Make the cancellation policy highly visible across all booking touchpoints to ensure clarity.                                                                 |
| **Operations Team** | **3. Improve Booking Management** | • The hotels should avoid same-day cancellations from no-deposit guests.<br>▪ **City Hotel:** nearly **800 cancellations within 7 days** before check-in, including **239 same-day cancellations (3%)**.<br>▪ **Resort Hotel:** the 0–7 day cancellation pattern exceeded the average, with consistently high cancellations within one week before check-in. | • Align room-management actions with each hotel's cancellation policy (e.g., cancellations within **48 hours** for City, **within 1 week** for Resort).<br>• Improve operational readiness to resell canceled rooms to Last-Minute guests.<br>• Reduce **331 same-day cancellations**, improving room allocation and minimizing revenue loss. |
